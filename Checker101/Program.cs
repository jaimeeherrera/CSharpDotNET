...
namespace Checkers
{
    ...
    public class Game
    {
        ...
        //check to see if the player wins the game
        public void ProcessInput()
        {
            ...
            if (srcChecker == null)
            {
                Console.WriteLine("Invalid Source Postion. Try again.00");
            }
            else
            {
                ...
                {
                    Console.WriteLine("Invalid Move. Double checck the source position and the destination poisiont and try again");
                }
